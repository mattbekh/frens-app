...
function TextContent(props) {
  ...
  useEffect(() => {
    ...
    tl.staggerFrom(
      ...
      .staggerTo([headlineFirst, headlineSecond, headlineThird], 1, {
        y: 250,
        ease: Power3.easeOut,
      })
      .to(textContent, 0, { css: { visibility: "hidden" } });

    tl.staggerTo([headlineFirst, headlineSecond, headlineThird], 0, {
      y: 0,
      ease: Power3.easeOut,
    });
    ...
    <Container ref={(el) => (content = el)}>
      ...
      <ButtonWrapper>
        ...
        <Link to={{ pathname: "/register" }}>
          ...
          >
            <RegisterButton className="fullContainer-text">
              Register
            </RegisterButton>
          </RegisterWrapper>
        </Link>
