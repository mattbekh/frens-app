                ...
                <ModalContainer className="modal-container">
                    ...
                    <ModalCardContainer className="modal-card-container">
                        <ModalImgWrapper className="modal-img-wrapper">
                            <ModalImg className="modal-img" src={props.modal.imgURL} alt={props.modal.name} />
                        </ModalImgWrapper>
                        <ModalTextWrapper className="modal-text-wrapper">
                            ...
                            <TopicLine className="topic-line">Out of topic? Try this!</TopicLine>
                            <RandomTopic className="random-topic">{randomTopic.topic}</RandomTopic>
                        </ModalTextWrapper>
                    </ModalCardContainer>
                </ModalContainer>
            ) : null}
